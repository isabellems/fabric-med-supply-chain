...
# Versions of fabric known not to work with this release of med-network
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run -v $PWD:/tmp/med-network --rm hyperledger/fabric-tools:$IMAGETAG rm -Rf /tmp/med-network/ledgers-backup
